            ...
            <nav class="bg-white border-b border-gray-200 px-4 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
              <div class="flex flex-wrap justify-between items-center">
                <div class="flex justify-start items-center">
                  ...
                  <span
                      class="self-center text-sm font-semibold whitespace-nowrap dark:text-white">CDS</span>
                  </a>
                ...
                <div class="flex items-center lg:order-2">
                  ...
                  >
                    ...
                    >
                      <li>
                        <a
                          href="{{route('teacherprofile.edit')}}"
                ...
                <ul class="space-y-2">
                  ...
                  <li>
                    ...
                    <ul id="dropdown-pages" class="hidden py-2 space-y-2">
                      ...
                      <li>
                        <a
                          href="{{route('teacher.myclassroom')}}"
                          class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                          >Class</a
                        >
                      </li>
                      <li>
                        <a
                          href="{{route('classroom.contentlist')}}"
                          class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                          >Content</a
                        >
                      </li>
                      <li>
                        <a
                          href="{{route('classroom.attendance')}}"
                          class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                          >Attendance</a
                        >
                      </li>
