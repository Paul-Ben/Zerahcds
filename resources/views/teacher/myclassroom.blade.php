        ...
        @forelse ($classrooms as $classroom)
            <div
                ...
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Here are the biggest enterprise technology
                    training of 2024 for Benue Tech Skills, in Benue State.</p>
                <a href="{{route('classroom.content', $classroom)}}"
                        class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add Content
                ...
                {{-- <form action="{{ route('classroom.destroy', $classroom) }}" method="post">
                    ...
                    Delete
                        <svg class="w-6 h-6 justify-between text-gray-800 dark:text-white" aria-hidden="true"
                            xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                            viewBox="0 0 24 24">
                            <path fill-rule="evenodd"
